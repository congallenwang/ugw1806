...
drv_mac80211_init_device_config() {
	...
	config_add_int beacon_int chanbw frag rts preamble
...
#Cong
mac80211_hostapd_cfg_wmm() {
    local config="$1"

    json_select config
   
    json_get_vars wmm_ac_be_aifs wmm_ac_be_cwmin wmm_ac_be_cwmax wmm_ac_be_txop_limit wmm_ac_bk_aifs wmm_ac_bk_cwmin wmm_ac_bk_cwmax wmm_ac_bk_txop_limit wmm_ac_vi_aifs wmm_ac_vi_cwmin wmm_ac_vi_cwmax wmm_ac_vi_txop_limit wmm_ac_vo_aifsi wmm_ac_vo_cwmin wmm_ac_vo_cwmax wmm_ac_vo_txop_limit 
...
${wmm_ac_be_aifs:+wmm_ac_be_aifs=$wmm_ac_be_aifs}
${wmm_ac_be_cwmin:+wmm_ac_be_cwmin=$wmm_ac_be_cwmin}
${wmm_ac_be_cwmax:+wmm_ac_be_cwmax=$wmm_ac_be_cwmax}
${wmm_ac_be_txop_limit:+wmm_ac_be_txop_limit=$wmm_ac_be_txop_limit}
${wmm_ac_bk_aifs:+wmm_ac_bk_aifs=$wmm_ac_bk_aifs}
${wmm_ac_bk_cwmin:+wmm_ac_bk_cwmin=$wmm_ac_bk_cwmin}
${wmm_ac_bk_cwmax:+wmm_ac_bk_cwmax=$wmm_ac_bk_cwmax}
${wmm_ac_bk_txop_limit:+wmm_ac_bk_txop_limit=$wmm_ac_bk_txop_limit}
${wmm_ac_vi_aifs:+wmm_ac_vi_aifs=$wmm_ac_vi_aifs}
${wmm_ac_vi_cwmin:+wmm_ac_vi_cwmin=$wmm_ac_vi_cwmin}
${wmm_ac_vi_cwmax:+wmm_ac_vi_cwmax=$wmm_ac_vi_cwmax}
${wmm_ac_vi_txop_limit:+wmm_ac_vi_txop_limit=$wmm_ac_vi_txop_limit}
${wmm_ac_vo_aifs:+wmm_ac_vo_aifs=$wmm_ac_vo_aifs}
${wmm_ac_vo_cwmin:+wmm_ac_vo_cwmin=$wmm_ac_vo_cwmin}
${wmm_ac_vo_cwmax:+wmm_ac_vo_cwmax=$wmm_ac_vo_cwmax}
${wmm_ac_vo_txop_limit:+wmm_ac_vo_txop_limit=$wmm_ac_vo_txop_limit}
...
mac80211_hostapd_setup_base() {
    ...
    set_default preamble 0

    hostapd_prepare_device_config "$hostapd_conf_file" nl80211
    mac80211_hostapd_cfg_wmm "$hostapd_conf_file"
